...
typedef  struct  os_tmr
{
	...
	// 消息驱动相关字段
  INT8U            OSTmrMsgDriven;                  /* 1: Message driven, 0: Callback driven */
  INT16S           OSTmrTaskID;                    /* Target task ID for message           */
  INT16U           OSTmrMsgCode;                   /* Message code to send                 */
  INT16U           OSTmrSendInst;                  /* Sender instance ID                   */
  INT16U           OSTmrRecvInst;                  /* Receiver instance ID                */
} OS_TMR;
